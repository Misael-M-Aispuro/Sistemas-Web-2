USE [master]
GO
/****** Object:  Database [TiendaSara]    Script Date: 22/02/2026 06:28:00 p. m. ******/
CREATE DATABASE [TiendaSara]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'TiendaSara', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\TiendaSara.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'TiendaSara_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\TiendaSara_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT, LEDGER = OFF
GO
ALTER DATABASE [TiendaSara] SET COMPATIBILITY_LEVEL = 160
GO
...
GO
EXEC sys.sp_db_vardecimal_storage_format N'TiendaSara', N'ON'
GO
...
USE [TiendaSara]
GO
/****** Object:  Table [dbo].[Carrito]    Script Date: 22/02/2026 06:28:00 p. m. ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[CarritoDetalle]    Script Date: 22/02/2026 06:28:00 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Categorias]    Script Date: 22/02/2026 06:28:00 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Marcas]    Script Date: 22/02/2026 06:28:00 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Productos]    Script Date: 22/02/2026 06:28:00 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
